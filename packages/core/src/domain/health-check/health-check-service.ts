...
export class HealthCheckService {
  ...
  private getDatasetDefinitions(
    ...
    const allDefinitions: DatasetDefinition[] = [
      ...
      {
        id: `${gitProviderId}.pipelines`,
        displayName: `${gitProviderId.toUpperCase()} Pipeline Runs (table: pipeline_runs)`,
      ...
      {
        id: `${gitProviderId}.pipeline-jobs`,
        displayName: `${gitProviderId.toUpperCase()} Pipeline Jobs (table: pipeline_jobs)`,
